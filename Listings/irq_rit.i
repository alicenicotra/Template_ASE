...
# 53 "C:\\Users\\Gaia\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdio.h" 3
...
{
# 91 "Source/RIT/IRQ_RIT.c"
    if(down_0 != 0){
        down_0++;
        if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<10)) == 0){ // Se premuto (LOW)
            switch(down_0){
...
# 195 "Source/RIT/IRQ_RIT.c"
    ...
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL |= 0x1; // Pulisce il flag di interrupt
