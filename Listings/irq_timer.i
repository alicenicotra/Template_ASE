...
void TIMER0_IRQHandler (void)
{
    ...
    {
# 70 "Source/timer/IRQ_timer.c"
        ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR = 1; // Pulisce il flag di interrupt MR0
    }
    ...
    else if(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR & 2)
    {
        ...
        ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR = 2; // Pulisce il flag MR1
    }
    ...
    else if(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR & 4)
    {
        ...
        ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR = 4; // Pulisce il flag MR2
    }
    ...
    else if(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR & 8)
    {
        ...
        ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR = 8; // Pulisce il flag MR3
    }
    return;
}
