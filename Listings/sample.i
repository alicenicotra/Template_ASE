...
# 1 "Source\\button/button.h" 1
# 15 "Source\\button/button.h"
...
int main(void)
{
    ...
    // ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1 << 12); // Enable ADC power
