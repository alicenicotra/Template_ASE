...
{
  // ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOUNTER = 0; // azzera contatore all’abilitazione -> permette di non chiamare reset_RIT() quando si vuole partire da zero
  ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL |= (1<<3); // Bit 3 = Timer Enable
    return;
}
...
{
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL &= ~(1<<3); // Bit 3 = Timer Disable
    return;
}
...
void reset_RIT( void )
{
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOUNTER = 0; // Scrive 0 nel contatore corrente
    return;
}
...
uint32_t init_RIT ( uint32_t RITInterval )
{
    ...
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 &= ~(3<<26); // Pulisce i bit 26 e 27
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 |= (1<<26); // Imposta a 1 (CCLK)
    ...
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL = (1<<1) | (1<<2);
