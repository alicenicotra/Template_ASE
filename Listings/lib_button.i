# 1 "Source/button/lib_button.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 404 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/button/lib_button.c" 2
...
# 8 "Source/button/lib_button.c" 2
...
# 24 "Source/button/lib_button.c"
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTMODE = 0x7; // 111 in binario -> Tutti e 3 Edge Sensitive
  ...
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTPOLAR &= ~(0x7); // Assicuro che siano a 0 (Falling Edge)
