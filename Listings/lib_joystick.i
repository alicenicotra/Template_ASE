...
# 10 "Source/joystick/lib_joystick.c" 2
# 1 "Source/joystick\\joystick.h" 1
# 15 "Source/joystick\\joystick.h"
void joystick_init(void);
# 11 "Source/joystick/lib_joystick.c" 2
# 22 "Source/joystick/lib_joystick.c"
void joystick_init(void) {
# 34 "Source/joystick/lib_joystick.c"
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 18); // Azzera bit 18 e 19 -> Imposta funzione 00 (GPIO)
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 25); // Azzera bit 25 -> Imposta direzione 0 (Input)


    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 20); // Shift 20: (26-16)*2 = 20. Imposta GPIO.
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 26); // Input


    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 22); // Shift 22: (27-16)*2 = 22. Imposta GPIO.
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 27); // Input


    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 24); // Shift 24: (28-16)*2 = 24. Imposta GPIO.
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 28); // Input


    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // Shift 26: (29-16)*2 = 26. Imposta GPIO.
