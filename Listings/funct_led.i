...
void LED_On(unsigned int num) {
    if(num < 8) {
        ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = led_mask[num]; // Scrivere 1 su FIOSET accende il bit
        led_value = (unsigned char)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN; // Aggiorna variabile globale
    }
}
...
void LED_Off(unsigned int num) {
    if(num < 8) {
        ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = led_mask[num]; // Scrivere 1 su FIOCLR spegne il bit
        led_value = (unsigned char)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN;
    }
}
...
void LED_Toggle(unsigned int num) {
    if(num < 8) {
        ...
        if (((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & led_mask[num]) {
            ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = led_mask[num]; // Era acceso, spegni
        } else {
            ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = led_mask[num]; // Era spento, accendi
        }
        led_value = (unsigned char)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN;
    }
}
...
void LED_Out(unsigned int value) {
    ...
    uint32_t current_state = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & 0xFFFFFF00;


    uint32_t new_bits = value & 0x000000FF;


    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN = current_state | new_bits;
...
void LED_Out_rev(unsigned int value) {
    ...
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0x000000FF;
