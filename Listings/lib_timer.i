...
# 8 "Source/timer/lib_timer.c" 2
# 1 "Source/timer\\timer.h" 1
# 21 "Source/timer\\timer.h"
...
void enable_timer( uint8_t timer_num )
{
    ...
    else ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR = 1;
    return;
}
...
void disable_timer( uint8_t timer_num )
{
    ...
    else ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR = 0;
    return;
}
...
uint32_t init_timer ( uint8_t timer_num, uint32_t Prescaler, uint8_t MatchReg, uint8_t SRImatchReg, uint32_t TimerInterval )
{
    ...
    switch(timer_num){
        case 0:
            TIMx = ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) );
            IRQn_Tx = TIMER0_IRQn;
            priority = 0; // Massima priorità
            break;
        case 1:
            TIMx = ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) );
            IRQn_Tx = TIMER1_IRQn;
            priority = 1;
            break;
        case 2:
            TIMx = ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) );
            IRQn_Tx = TIMER2_IRQn;
            priority = 2;
            break;
        case 3:
            TIMx = ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) );
            IRQn_Tx = TIMER3_IRQn;
            priority = 3;
            break;
  ...
  TIMx->MCR |= (SRImatchReg << (3 * MatchReg));
    ...
    __NVIC_EnableIRQ(IRQn_Tx);
    __NVIC_SetPriority(IRQn_Tx, priority); // Imposta priorità (0 è la più alta)
